    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <h2 className="text-xs text-pink-500 tracking-widest font-medium title-font mb-1">CATEGORIES</h2>
                ...
                <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                  ...
                  <div className="flex-grow">
                    <p className="leading-relaxed text-base">
                      Discover a wide range of products in this category. Browse through our collection and find the perfect item for you.
                    </p>
